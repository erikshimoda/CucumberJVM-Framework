...
public class GerarCPFCNPJ {
	...
	private int gerarNumeroRandomico(int n) {
		int ranNum = (int) (Math.random() * n);
		return ranNum;
	}

	private int mod(int dividendo, int divisor) {
		return (int) Math.round(dividendo
				- (Math.floor(dividendo / divisor) * divisor));
	}

	public String cpf() {
		int n = 9;
		int n1 = gerarNumeroRandomico(n);
		int n2 = gerarNumeroRandomico(n);
		int n3 = gerarNumeroRandomico(n);
		int n4 = gerarNumeroRandomico(n);
		int n5 = gerarNumeroRandomico(n);
		int n6 = gerarNumeroRandomico(n);
		int n7 = gerarNumeroRandomico(n);
		int n8 = gerarNumeroRandomico(n);
		int n9 = gerarNumeroRandomico(n);
		int d1 = n9 * 2 + n8 * 3 + n7 * 4 + n6 * 5 + n5 * 6 + n4 * 7 + n3 * 8
				+ n2 * 9 + n1 * 10;
		...
		int d2 = d1 * 2 + n9 * 3 + n8 * 4 + n7 * 5 + n6 * 6 + n5 * 7 + n4 * 8
				+ n3 * 9 + n2 * 10 + n1 * 11;
	...
	public String cnpj() {
		...
		int d1 = n12 * 2 + n11 * 3 + n10 * 4 + n9 * 5 + n8 * 6 + n7 * 7 + n6
		...
		int d2 = d1 * 2 + n12 * 3 + n11 * 4 + n10 * 5 + n9 * 6 + n8 * 7 + n7
		...
		if (comPontos)
			...
			retorno = "" + n1 + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10
					+ n11 + n12 + d1 + d2;
